...
from encoding.nn import SegmentationMultiLosses, nll_SegmentationMultiLosses, nll4_SegmentationMultiLosses, nll5_SegmentationMultiLosses,nll1_SegmentationMultiLosses
...
class Trainer():
    def __init__(self, args):
        ...
        # self.criterion = nll5_SegmentationMultiLosses(nclass=self.nclass, weight=cityscape_weight)
        self.criterion = nll1_SegmentationMultiLosses(nclass=self.nclass)
