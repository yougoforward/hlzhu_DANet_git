...
from encoding.nn import SegmentationMultiLosses, nll_SegmentationMultiLosses, nll4_SegmentationMultiLosses
...
class Trainer():
    def __init__(self, args):
        ...
        self.valloader = data.DataLoader(testset, batch_size=4,
