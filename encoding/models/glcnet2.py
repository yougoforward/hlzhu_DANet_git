...
__all__ = ['GLCNet2', 'get_glcnet2']


class GLCNet2(BaseNet):
...
class GLCNet2Head(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        super(GLCNet2Head, self).__init__()
...
def get_glcnet2(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    model = GLCNet2(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
