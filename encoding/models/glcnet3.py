...
__all__ = ['GLCNet3', 'get_glcnet3']


class GLCNet3(BaseNet):
    ...
    def __init__(self, nclass, backbone, aux=False, se_loss=False, norm_layer=nn.BatchNorm2d, **kwargs):
        super(GLCNet3, self).__init__(nclass, backbone, aux, se_loss, norm_layer=norm_layer, **kwargs)
        self.head = GLCNet3Head(2048, nclass, norm_layer)
...
class GLCNet3Head(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        super(GLCNet3Head, self).__init__()
...
def get_glcnet3(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    model = GLCNet3(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
