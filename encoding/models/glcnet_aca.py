...
__all__ = ['GLCNet5_aca', 'get_glcnet5_aca']


class GLCNet5_aca(BaseNet):
...
def get_glcnet5_aca(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    model = GLCNet5_aca(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
