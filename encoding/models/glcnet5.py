...
__all__ = ['GLCNet5', 'get_glcnet5']


class GLCNet5(BaseNet):
...
class GLCNet5Head(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        super(GLCNet5Head, self).__init__()
...
def get_glcnet5(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    model = GLCNet5(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
