...
class LGNetHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        super(LGNetHead, self).__init__()
...
def get_lgnet(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    model = LGNet(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
