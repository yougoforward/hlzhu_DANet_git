...
class Bottleneck_nlp(nn.Module):
    """ResNet Bottleneck
    """
    # pylint: disable=unused-argument
    expansion = 4
...
class Bottleneck_pnlp(nn.Module):
    """ResNet Bottleneck
    """
    # pylint: disable=unused-argument
    expansion = 4
...
class ResNet_nlp(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, norm_layer=nn.BatchNorm2d, multi_grid=False, multi_dilation=None):
        self.inplanes = 64
        super(ResNet_nlp, self).__init__()
...
def resnet50_nlp(pretrained=False, root='./pretrain_models', **kwargs):
    """Constructs a ResNet-50 model.
